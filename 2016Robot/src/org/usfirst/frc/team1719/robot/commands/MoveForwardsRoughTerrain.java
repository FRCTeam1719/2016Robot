 ...
 *
 */
public class MoveForwardsRoughTerrain extends Command {
	 ...
	 *            to move forward
	 */
	public MoveForwardsRoughTerrain(double distFeet, double speed) {
	...
	protected boolean isFinished() {
		if (RobotMap.ultrasonic.getDistanceFeet() < 1) {
			return true;
		}
		else {
